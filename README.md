...
- PDF resume download (linked externally if needed)
...
Recruiters, hiring managers, and fellow developers who want to understand your background, see your work, and read your writing.

---

## Success Criteria

- All five content types manageable entirely from Sanity Studio without touching code
- New blog post published in Sanity → live on site within 60 seconds via webhook
- Lighthouse score 95+ on performance, accessibility, SEO
- All pages render correctly with empty content (no broken layouts)
- Dark and light mode both look polished
- Mobile layout clean on 375px viewport
